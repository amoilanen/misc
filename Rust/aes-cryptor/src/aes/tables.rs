//! AES lookup tables for SubBytes and key expansion

/// S-box lookup table for SubBytes transformation
/// Source: FIPS 197 Table 5
...
/// These tables contain pre-computed results of GF(2^8) multiplication
