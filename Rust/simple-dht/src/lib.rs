...
mod tests {
    ...
    fn test_distance_different_msb() {
        ...
        assert_eq!(NodeId(id1).distance(&NodeId(id2)), 0);
    }
    ...
    fn test_distance_different_lsb() {
        ...
        assert_eq!(NodeId(id1).distance(&NodeId(id2)), 255);
    }
    ...
    fn test_distance_middle_bytes() {
        ...
        id2[15] = 0b00000000;
        assert_eq!(NodeId(id1).distance(&NodeId(id2)), 123);
    }
