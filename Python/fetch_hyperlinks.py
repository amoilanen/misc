...
# Usage:
#    python3 fetch_hyperlinks.py --url http://archive.org/download/MIT18.06S05_MP4/ --save_to_dir=/home/anton/Educational/MIT/18-06-linear-algebra-spring-2010 --ext "ogv,srt,gif"
#
import re
import os
import click
...
def download_url(url, destination_file):
    ...
    content_length = int(url_info.get('Content-Length'))
